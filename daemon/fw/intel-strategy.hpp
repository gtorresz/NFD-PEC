 ...
 */
class intelStrategy : public Strategy
                        , public ProcessNackTraits<intelStrategy>
{
public:
  explicit
  intelStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<intelStrategy>;
